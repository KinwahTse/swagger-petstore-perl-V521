...
class FsClientGroupsApi(object):
    ...
    def list_fs_client_groups(self, **kwargs):  # noqa: E501
        ...
        :param int not_dfs_nfs_share_id: id of dfs nfs share client groups not in
    ...
    def list_fs_client_groups_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['limit', 'offset', 'cluster_id', 'q', 'sort', 'fs_client_id', 'not_dfs_nfs_share_id']  # noqa: E501
        all_params.append('async')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
