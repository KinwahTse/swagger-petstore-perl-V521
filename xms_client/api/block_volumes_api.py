...
class BlockVolumesApi(object):
    ...
    def list_block_volumes(self, **kwargs):  # noqa: E501
        ...
        :param str pool_name: The pool_name of the pool volumes belong to
        :param str cluster_id: cluster id
        :param int block_snapshot_id: related snapshot id
        :param str name: name of volume
        :param str name_prefix: name prefix of volume
        :param str volume_name: volume_name of volume
        :param str uid: uid of volume
        :param int client_group_id: related client group id
        :param int mapping_group_id: related mapping group id
        :param int exclude_mapping_group_id: exclude mapping group id, with access path id
        :param int access_path_id: related access path id
        :param bool passive: passive or not
        :param bool recycled: recycled or not
        :param str status: filter with status
        :param bool with_not_used: list with not used volumes, can be used with access path id
    ...
    def list_block_volumes_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['limit', 'offset', 'pool_id', 'pool_name', 'cluster_id', 'block_snapshot_id', 'name', 'name_prefix', 'volume_name', 'uid', 'client_group_id', 'mapping_group_id', 'exclude_mapping_group_id', 'access_path_id', 'passive', 'recycled', 'status', 'with_not_used', 'q', 'sort', 'all', 'dp_block_backup_policy_id', 'dp_block_async_replication_policy_id', 'could_have_io']  # noqa: E501
        all_params.append('async')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if 'pool_name' in params:
            query_params.append(('pool_name', params['pool_name']))  # noqa: E501
        ...
        if 'name_prefix' in params:
            query_params.append(('name_prefix', params['name_prefix']))  # noqa: E501
        ...
        if 'exclude_mapping_group_id' in params:
            query_params.append(('exclude_mapping_group_id', params['exclude_mapping_group_id']))  # noqa: E501
        ...
        if 'with_not_used' in params:
            query_params.append(('with_not_used', params['with_not_used']))  # noqa: E501
        if 'q' in params:
    ...
    def update_block_volume_volume_name(self, block_volume_id, body, **kwargs):  # noqa: E501
        """update_block_volume_volume_name  # noqa: E501

        Update block volume volume_name  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.update_block_volume_volume_name(block_volume_id, body, async=True)
        >>> result = thread.get()

        :param async bool
        :param int block_volume_id: the block volume id (required)
        :param VolumeUpdateVolumeNameReq body: volume volume_name (required)
        :return: VolumeResp
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.update_block_volume_volume_name_with_http_info(block_volume_id, body, **kwargs)  # noqa: E501
        else:
            (data) = self.update_block_volume_volume_name_with_http_info(block_volume_id, body, **kwargs)  # noqa: E501
            return data

    def update_block_volume_volume_name_with_http_info(self, block_volume_id, body, **kwargs):  # noqa: E501
        """update_block_volume_volume_name  # noqa: E501

        Update block volume volume_name  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.update_block_volume_volume_name_with_http_info(block_volume_id, body, async=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_block_volume_volume_name" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'block_volume_id' is set
        if ('block_volume_id' not in params or
                params['block_volume_id'] is None):
            raise ValueError("Missing the required parameter `block_volume_id` when calling `update_block_volume_volume_name`")  # noqa: E501
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `update_block_volume_volume_name`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/block-volumes/{block_volume_id}:update-volume-name', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def update_volume_stat(self, body, **kwargs):  # noqa: E501
        """update_volume_stat  # noqa: E501

        update volume stat from other cluster  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.update_volume_stat(body, async=True)
        >>> result = thread.get()

        :param async bool
        :param UpdateVolumeStatReq body: volume stat (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.update_volume_stat_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.update_volume_stat_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def update_volume_stat_with_http_info(self, body, **kwargs):  # noqa: E501
        """update_volume_stat  # noqa: E501

        update volume stat from other cluster  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.update_volume_stat_with_http_info(body, async=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_volume_stat" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `update_volume_stat`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/block-volumes/:update-stat', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
