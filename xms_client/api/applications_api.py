...
class ApplicationsApi(object):
    ...
    def create_application(self, body, **kwargs):  # noqa: E501
        ...
        Create application info  # noqa: E501
        ...
        :param async bool
        :param ApplicationCreateReq body: application info (required)
    ...
    def create_application_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='ApplicationResp',  # noqa: E501
    ...
    def delete_application(self, application_id, **kwargs):  # noqa: E501
        ...
        delete application info  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.delete_application(application_id, async=True)
        >>> result = thread.get()
    ...
    def delete_application_with_http_info(self, application_id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.delete_application_with_http_info(application_id, async=True)
        >>> result = thread.get()
    ...
    def list_applications(self, **kwargs):  # noqa: E501
        ...
        get application informations  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.list_applications(async=True)
        >>> result = thread.get()
    ...
    def list_applications_with_http_info(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.list_applications_with_http_info(async=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='ApplicationsResp',  # noqa: E501
            auth_settings=auth_settings,
            async=params.get('async'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def update_application(self, application_id, body, **kwargs):  # noqa: E501
        """update_application  # noqa: E501

        set application info  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.update_application(application_id, body, async=True)
        >>> result = thread.get()

        :param async bool
        :param int application_id: appliction id (required)
        :param ApplicationUpdateReq body: application info (required)
        :return: ApplicationResp
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.update_application_with_http_info(application_id, body, **kwargs)  # noqa: E501
        else:
            (data) = self.update_application_with_http_info(application_id, body, **kwargs)  # noqa: E501
            return data

    def update_application_with_http_info(self, application_id, body, **kwargs):  # noqa: E501
        """update_application  # noqa: E501

        set application info  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.update_application_with_http_info(application_id, body, async=True)
        >>> result = thread.get()
