...
class TargetsApi(object):
    ...
    def add_target_gateway_i_ps(self, target_id, body, **kwargs):  # noqa: E501
        """add_target_gateway_i_ps  # noqa: E501

        Add gateway ips to target  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.add_target_gateway_i_ps(target_id, body, async=True)
        >>> result = thread.get()

        :param async bool
        :param int target_id: target id (required)
        :param TargetAddGatewayIPsReq body: gateway ips info (required)
        :return: TargetResp
        ...
        if kwargs.get('async'):
            return self.add_target_gateway_i_ps_with_http_info(target_id, body, **kwargs)  # noqa: E501
        else:
            (data) = self.add_target_gateway_i_ps_with_http_info(target_id, body, **kwargs)  # noqa: E501
            return data

    def add_target_gateway_i_ps_with_http_info(self, target_id, body, **kwargs):  # noqa: E501
        """add_target_gateway_i_ps  # noqa: E501

        Add gateway ips to target  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.add_target_gateway_i_ps_with_http_info(target_id, body, async=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method add_target_gateway_i_ps" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('target_id' not in params or
            ...
            raise ValueError("Missing the required parameter `target_id` when calling `add_target_gateway_i_ps`")  # noqa: E501
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `add_target_gateway_i_ps`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/targets/{target_id}:add-gateway-ips', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def list_targets_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['limit', 'offset', 'cluster_id', 'host_id', 'access_path_id', 'q', 'sort']  # noqa: E501
        all_params.append('async')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
