...
class FsUserGroupsApi(object):
    ...
    def list_fs_user_groups(self, **kwargs):  # noqa: E501
        ...
        :param int not_dfs_smb_share_id: id of dfs smb share user groups not in
    ...
    def list_fs_user_groups_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['limit', 'offset', 'q', 'sort', 'cluster_id', 'type', 'fs_user_id', 'not_dfs_smb_share_id']  # noqa: E501
        all_params.append('async')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
