...
class AlertsApi(object):
    ...
    def list_alerts_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['limit', 'offset', 'resource_type', 'resource_id', 'alert_type', 'acked', 'resolved', 'resolve_type', 'level', 'duration_begin', 'duration_end', 'duration_limit', 'duration_offset', 'q', 'related_resource', 'sort']  # noqa: E501
        all_params.append('async')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
