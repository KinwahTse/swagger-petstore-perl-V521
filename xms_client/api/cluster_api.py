...
class ClusterApi(object):
    ...
    def download(self, paths, **kwargs):  # noqa: E501
        """download  # noqa: E501

        download the file which in whitelist path  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.download(paths, async=True)
        >>> result = thread.get()

        :param async bool
        :param str paths: file path (required)
        :return: str
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.download_with_http_info(paths, **kwargs)  # noqa: E501
        else:
            (data) = self.download_with_http_info(paths, **kwargs)  # noqa: E501
            return data

    def download_with_http_info(self, paths, **kwargs):  # noqa: E501
        """download  # noqa: E501

        download the file which in whitelist path  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.download_with_http_info(paths, async=True)
        >>> result = thread.get()
        ...
        if ('paths' not in params or
            ...
            raise ValueError("Missing the required parameter `paths` when calling `download`")  # noqa: E501
    ...
    def get_object_storage_samples_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['cluster_id', 'duration_begin', 'duration_end', 'period']  # noqa: E501
        all_params.append('async')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def set_cluster_network(self, body, **kwargs):  # noqa: E501
        """set_cluster_network  # noqa: E501

        Set cluster gateway networks  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.set_cluster_network(body, async=True)
        >>> result = thread.get()

        :param async bool
        :param ClusterSetNetworkReq body: gateway network (required)
        :param str cluster_id: cluster id
        :return: ClusterResp
                 If the method is called asynchronously,
                 returns the request thread.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.set_cluster_network_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.set_cluster_network_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def set_cluster_network_with_http_info(self, body, **kwargs):  # noqa: E501
        """set_cluster_network  # noqa: E501

        Set cluster gateway networks  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.set_cluster_network_with_http_info(body, async=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method set_cluster_network" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `set_cluster_network`")  # noqa: E501
