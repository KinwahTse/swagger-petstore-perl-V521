...
class ClustersApi(object):
    ...
    def create_cluster(self, body, **kwargs):  # noqa: E501
        ...
        >>> thread = api.create_cluster(body, async=True)
        >>> result = thread.get()

        :param async bool
        :param ClusterCreateReq body: cluster info (required)
        :return: ClusterResp
    ...
    def create_cluster_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.create_cluster_with_http_info(body, async=True)
        >>> result = thread.get()
    ...
    def delete_cluster(self, cluster_id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.delete_cluster(cluster_id, async=True)
        >>> result = thread.get()

        :param async bool
        :param int cluster_id: cluster id (required)
        :return: ClusterResp
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def delete_cluster_with_http_info(self, cluster_id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.delete_cluster_with_http_info(cluster_id, async=True)
        >>> result = thread.get()
    ...
    def list_clusters_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['limit', 'offset', 'q', 'sort', 'type']  # noqa: E501
        all_params.append('async')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='ClustersResp',  # noqa: E501
            auth_settings=auth_settings,
            async=params.get('async'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
