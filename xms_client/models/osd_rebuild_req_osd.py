...
class OsdRebuildReqOsd(object):
    ...
    attribute_map = {
        ...
        'new_min_alloc_size': 'new_min_alloc_size',
        'new_omap_byte': 'new_omap_byte',
        'new_partition_id': 'new_partition_id',
        'new_read_cache_size': 'new_read_cache_size'
    }

    def __init__(self, new_disk_id=None, new_min_alloc_size=None, new_omap_byte=None, new_partition_id=None, new_read_cache_size=None):  # noqa: E501
        """OsdRebuildReqOsd - a model defined in Swagger"""  # noqa: E501

        self._new_disk_id = None
        self._new_min_alloc_size = None
        ...
        if new_min_alloc_size is not None:
            self.new_min_alloc_size = new_min_alloc_size
    ...
    @property
    def new_min_alloc_size(self):
        """Gets the new_min_alloc_size of this OsdRebuildReqOsd.  # noqa: E501

        see OsdCreateReq.Osd.MinAllocSize  # noqa: E501

        :return: The new_min_alloc_size of this OsdRebuildReqOsd.  # noqa: E501
        :rtype: int
        """
        return self._new_min_alloc_size

    @new_min_alloc_size.setter
    def new_min_alloc_size(self, new_min_alloc_size):
        """Sets the new_min_alloc_size of this OsdRebuildReqOsd.

        see OsdCreateReq.Osd.MinAllocSize  # noqa: E501

        :param new_min_alloc_size: The new_min_alloc_size of this OsdRebuildReqOsd.  # noqa: E501
        :type: int
        """

        self._new_min_alloc_size = new_min_alloc_size
