...
class ClientGroup(object):
    ...
    def __init__(self, access_path_num=None, block_volume_num=None, chap=None, client_num=None, clients=None, create=None, description=None, id=None, iname=None, isecret=None, name=None, status=None, type=None, uid=None, update=None):  # noqa: E501
