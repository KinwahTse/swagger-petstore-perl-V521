...
class HostStat(object):
    ...
    attribute_map = {
        ...
        'network_tx_drop_ratio': 'network_tx_drop_ratio',
        'network_tx_error_pps': 'network_tx_error_pps',
        'network_tx_error_ratio': 'network_tx_error_ratio',
        'network_tx_pps': 'network_tx_pps',
        'page_paging_ps': 'page_paging_ps'
    }

    def __init__(self, context_switch_ps=None, cpu_util=None, create=None, interrupts_ps=None, load15min=None, load1min=None, load5min=None, mem_usage_percent=None, meta_docker_used_kbyte=None, meta_elasticsearch_used_kbyte=None, meta_etcd_used_kbyte=None, meta_log_used_kbyte=None, meta_mon_used_kbyte=None, meta_postgres_used_kbyte=None, meta_prometheus_used_kbyte=None, network_drop_pps=None, network_drop_ratio=None, network_error_pps=None, network_error_ratio=None, network_rx_bandwidth_kbyte=None, network_rx_drop_pps=None, network_rx_drop_ratio=None, network_rx_error_pps=None, network_rx_error_ratio=None, network_rx_pps=None, network_tx_bandwidth_kbyte=None, network_tx_drop_pps=None, network_tx_drop_ratio=None, network_tx_error_pps=None, network_tx_error_ratio=None, network_tx_pps=None, page_paging_ps=None):  # noqa: E501
        ...
        if network_drop_ratio is not None:
            self.network_drop_ratio = network_drop_ratio
        if network_error_pps is not None:
            self.network_error_pps = network_error_pps
        if network_error_ratio is not None:
            self.network_error_ratio = network_error_ratio
        ...
        if network_rx_drop_ratio is not None:
            self.network_rx_drop_ratio = network_rx_drop_ratio
        if network_rx_error_pps is not None:
            self.network_rx_error_pps = network_rx_error_pps
        if network_rx_error_ratio is not None:
            self.network_rx_error_ratio = network_rx_error_ratio
        ...
        if network_tx_drop_ratio is not None:
            self.network_tx_drop_ratio = network_tx_drop_ratio
        if network_tx_error_pps is not None:
            self.network_tx_error_pps = network_tx_error_pps
        if network_tx_error_ratio is not None:
            self.network_tx_error_ratio = network_tx_error_ratio
    ...
    @property
    def network_drop_ratio(self):
        """Gets the network_drop_ratio of this HostStat.  # noqa: E501


        :return: The network_drop_ratio of this HostStat.  # noqa: E501
        :rtype: float
        """
        return self._network_drop_ratio

    @network_drop_ratio.setter
    def network_drop_ratio(self, network_drop_ratio):
        """Sets the network_drop_ratio of this HostStat.


        :param network_drop_ratio: The network_drop_ratio of this HostStat.  # noqa: E501
        :type: float
        """

        self._network_drop_ratio = network_drop_ratio
    ...
    @property
    def network_error_ratio(self):
        """Gets the network_error_ratio of this HostStat.  # noqa: E501


        :return: The network_error_ratio of this HostStat.  # noqa: E501
        :rtype: float
        """
        return self._network_error_ratio

    @network_error_ratio.setter
    def network_error_ratio(self, network_error_ratio):
        """Sets the network_error_ratio of this HostStat.


        :param network_error_ratio: The network_error_ratio of this HostStat.  # noqa: E501
        :type: float
        """

        self._network_error_ratio = network_error_ratio
    ...
    @property
    def network_rx_drop_ratio(self):
        """Gets the network_rx_drop_ratio of this HostStat.  # noqa: E501


        :return: The network_rx_drop_ratio of this HostStat.  # noqa: E501
        :rtype: float
        """
        return self._network_rx_drop_ratio

    @network_rx_drop_ratio.setter
    def network_rx_drop_ratio(self, network_rx_drop_ratio):
        """Sets the network_rx_drop_ratio of this HostStat.


        :param network_rx_drop_ratio: The network_rx_drop_ratio of this HostStat.  # noqa: E501
        :type: float
        """

        self._network_rx_drop_ratio = network_rx_drop_ratio
    ...
    @property
    def network_rx_error_ratio(self):
        """Gets the network_rx_error_ratio of this HostStat.  # noqa: E501


        :return: The network_rx_error_ratio of this HostStat.  # noqa: E501
        :rtype: float
        """
        return self._network_rx_error_ratio

    @network_rx_error_ratio.setter
    def network_rx_error_ratio(self, network_rx_error_ratio):
        """Sets the network_rx_error_ratio of this HostStat.


        :param network_rx_error_ratio: The network_rx_error_ratio of this HostStat.  # noqa: E501
        :type: float
        """

        self._network_rx_error_ratio = network_rx_error_ratio
    ...
    @property
    def network_tx_drop_ratio(self):
        """Gets the network_tx_drop_ratio of this HostStat.  # noqa: E501


        :return: The network_tx_drop_ratio of this HostStat.  # noqa: E501
        :rtype: float
        """
        return self._network_tx_drop_ratio

    @network_tx_drop_ratio.setter
    def network_tx_drop_ratio(self, network_tx_drop_ratio):
        """Sets the network_tx_drop_ratio of this HostStat.


        :param network_tx_drop_ratio: The network_tx_drop_ratio of this HostStat.  # noqa: E501
        :type: float
        """

        self._network_tx_drop_ratio = network_tx_drop_ratio
    ...
    @property
    def network_tx_error_ratio(self):
        """Gets the network_tx_error_ratio of this HostStat.  # noqa: E501


        :return: The network_tx_error_ratio of this HostStat.  # noqa: E501
        :rtype: float
        """
        return self._network_tx_error_ratio

    @network_tx_error_ratio.setter
    def network_tx_error_ratio(self, network_tx_error_ratio):
        """Sets the network_tx_error_ratio of this HostStat.


        :param network_tx_error_ratio: The network_tx_error_ratio of this HostStat.  # noqa: E501
        :type: float
        """

        self._network_tx_error_ratio = network_tx_error_ratio
