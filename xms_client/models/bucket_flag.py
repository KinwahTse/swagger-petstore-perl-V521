...
class BucketFlag(object):
    ...
    """
    swagger_types = {
        'delete_trigger_archive_tier': 'bool',
    ...
    attribute_map = {
        'delete_trigger_archive_tier': 'delete_trigger_archive_tier',
    ...
    def __init__(self, delete_trigger_archive_tier=None, get_trigger_restore=None, readonly=None, recycle=None, tier_cache=None, tier_retain_external_object=None, tier_worm=None, versioned=None, versions_suspended=None, worm=None):  # noqa: E501
        """BucketFlag - a model defined in Swagger"""  # noqa: E501

        self._delete_trigger_archive_tier = None
        ...
        if delete_trigger_archive_tier is not None:
            self.delete_trigger_archive_tier = delete_trigger_archive_tier
    ...
    @property
    def delete_trigger_archive_tier(self):
        """Gets the delete_trigger_archive_tier of this BucketFlag.  # noqa: E501


        :return: The delete_trigger_archive_tier of this BucketFlag.  # noqa: E501
        :rtype: bool
        """
        return self._delete_trigger_archive_tier

    @delete_trigger_archive_tier.setter
    def delete_trigger_archive_tier(self, delete_trigger_archive_tier):
        """Sets the delete_trigger_archive_tier of this BucketFlag.


        :param delete_trigger_archive_tier: The delete_trigger_archive_tier of this BucketFlag.  # noqa: E501
        :type: bool
        """

        self._delete_trigger_archive_tier = delete_trigger_archive_tier
    ...
    @property
    def recycle(self):
        """Gets the recycle of this BucketFlag.  # noqa: E501


        :return: The recycle of this BucketFlag.  # noqa: E501
        :rtype: bool
        """
    ...
    def recycle(self, recycle):
        """Sets the recycle of this BucketFlag.


        :param recycle: The recycle of this BucketFlag.  # noqa: E501
        :type: bool
        """
