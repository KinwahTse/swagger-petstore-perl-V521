...
# from xms_client.models.volume_failed_task import VolumeFailedTask  # noqa: F401,E501
# from xms_client.models.volume_io_latency import VolumeIOLatency  # noqa: F401,E501
# from xms_client.models.volume_io_size import VolumeIOSize  # noqa: F401,E501
# from xms_client.models.volume_non_io_task import VolumeNonIOTask  # noqa: F401,E501
...
class VolumeStat(object):
    ...
    def __init__(self, failed_task=None, create=None, io_size=None, io_size_lat=None, migrate_write_bandwidth_kbyte=None, migrate_write_iops=None, migrate_write_latency_us=None, non_io_task=None, queue_depth=None, read_bandwidth_kbyte=None, read_iops=None, read_latency_us=None, total_bandwidth_kbyte=None, total_iops=None, write_bandwidth_kbyte=None, write_iops=None, write_latency_us=None):  # noqa: E501
        """VolumeStat - a model defined in Swagger"""  # noqa: E501

        self._failed_task = None
        self._create = None
        self._io_size = None
        self._io_size_lat = None
        ...
        if io_size_lat is not None:
            self.io_size_lat = io_size_lat
    ...
    @property
    def io_size_lat(self):
        """Gets the io_size_lat of this VolumeStat.  # noqa: E501


        :return: The io_size_lat of this VolumeStat.  # noqa: E501
        :rtype: VolumeIOLatency
        """
        return self._io_size_lat

    @io_size_lat.setter
    def io_size_lat(self, io_size_lat):
        """Sets the io_size_lat of this VolumeStat.


        :param io_size_lat: The io_size_lat of this VolumeStat.  # noqa: E501
        :type: VolumeIOLatency
        """

        self._io_size_lat = io_size_lat
